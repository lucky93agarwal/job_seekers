...
class FontUtilities {
  ...
  /// AppBar Font Style
  static TextStyle appBarTextStyle({required Color? color}) =>
      TextStyle(fontFamily: "Mukta", fontSize: 20, color: color, fontWeight: FontWeight.w500);
}
